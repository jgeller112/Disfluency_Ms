...
fit_mem1 <- read_rds("https://osf.io/apcnb/download")
...
```{r}
#HB > C
a <- hypothesis(fit_mem1 , "isold:blurblur1 > 0")
b <- hypothesis(fit_mem1 , "isold:blurblur2 > 0")
...
fit_mem_noc <- read_rds("https://osf.io/2jh86/download")
...
```{r}
#HB > C
a <- hypothesis(fit_mem_noc , "isold:blurblur1 > 0")
b <- hypothesis(fit_mem_noc , "isold:blurblur2 > 0")
...
The word frequency effect on skew was amplified for both high-blurred vs. clear words, $b$ = `r s$Estimate`, 90% CrI [`r s$CI.Lower`, `r s$CI.Upper`], ER = `r s$Evid.Ratio`, and low-blurred vs. clear words, $b$ = `r t$Estimate`, 90% CrI [`r t$CI.Lower`, `r t$CI.Upper`], ER = `r t$Evid.Ratio`, with greater skewing for low- than high-frequency words. No interaction was found in the low-blurred vs. clear contrast, $b$ = `r u$Estimate`, 95% CrI [`r u$CI.Lower`, `r u$CI.Upper`], ER = `r u$Evid.Ratio`.
