...
::: memo-reviewer
**Reviewer 2**: Relatedly, I do not believe that the observed correspondence between the two kinds
of models in experiments 1a and 1b is sufficient for assuming equivalence of the
processes reflected by the derived parameters (p. 41). The authors should be more
careful with such statements.
:::

We appreciate this important point. In the revision, we removed the claim of correspondence to avoid overstating the equivalence between the processes reflected by the model parameters.
...
Thank you for noting this. We have revised the sentence for clarity.
