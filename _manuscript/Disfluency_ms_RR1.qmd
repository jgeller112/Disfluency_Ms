...
#| label: tbl-predictions
#| tbl-cap: "Mapping model predictions to theoretical constructs"
#| apa-note: "↑ = larger; ↓ = smaller; × = no effect on parameter of interest"
...
data <- data.frame(
  ...
  RecognitionMemoryPredictions = c(
    ...
    "High > Low/clear",
    "Low  =  clear",        # Compensatory-processing
    "High > Low/clear",
...
ft <- flextable::flextable(data) |>
  ...
  flextable::merge_v(j = c("Account", "Description", "Loci")) |>
  flextable::valign(j = c("Account", "Description", "Loci"), valign = "top") |>
  flextable::align(
    j = c("Account", "Description", "Loci", "Contrast"),
    align = "left", part = "body"
  ) |>
  flextable::align(
    j = c("ExGaussianPredictions", "QuantilePlots", "RecognitionMemoryPredictions"),
    align = "center", part = "body"
  ) |>
  flextable::width(j = "Account", width = 1) |>
  flextable::width(j = "Description", width = 2) |>
  flextable::width(j = "Loci", width = 1.2) |>
  flextable::width(j = "Contrast", width = 1.4) |>
  flextable::width(j = "ExGaussianPredictions", width = 1.6) |>
  flextable::width(j = "QuantilePlots", width = 1.7) |>
  flextable::width(j = "RecognitionMemoryPredictions", width = 1.9) |>
