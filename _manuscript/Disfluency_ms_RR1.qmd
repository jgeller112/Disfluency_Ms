...
#| fig-cap: "Quantile plots for each blur condition in Experiment 1A and 1B (A) and Delta plots depicting the magnitude of the effect for hypotheses of interest over time in Experiments 1A (B) and 1B (C). Each dot represents the mean RT at the .1, .3, .5, .7 and .9 quantiles."
#| fig-width: 20
#| fig-height: 12
