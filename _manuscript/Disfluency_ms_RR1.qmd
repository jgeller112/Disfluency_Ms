...
The analysis of accuracy is based on `r dim(blur_acc)[1]` data points. After removing fast (\< .2 s) and slow (\> 2.5 s) RTs (`r round(1-dim(blur_acc_new)[1]/dim(blur_acc)[1], 3)`) we were left with `r dim(blur_acc_new)[1]` data point points
...
The analysis of accuracy is based on `r dim(blur_acc)[1]` data points. After removing fast (\< .2 s) and slow (\> 2.5 s) RTs (`r round(1-dim(blur_acc_new)[1]/dim(blur_acc)[1], 2)`) we were left with `r dim(blur_acc_new)[1]` data point points.
...
The analysis of accuracy is based on `r dim(rts_dim)[1]` data points. After removing fast (\> 2.5 s) and slow ( \< .2 s) RTs (`r round(1-dim(blur_acc_wf)[1]/dim(rts_dim)[1], 3)`), we were left with `r dim(blur_acc_wf)[1]` data points.
