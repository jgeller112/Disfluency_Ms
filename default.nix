# This file was generated by the {rix} R package v0.15.6 on 2025-03-16
# with following call:
# >rix(date = "2025-03-10",
...
let
 pkgs = import (fetchTarball "https://github.com/TomaSajt/nixpkgs/archive/rstudio.tar.gz") { config.allowUnfree = true; };
